...
<head>
    ...
    <script>
        $(document).ready(function () {
            ...
            $.ajax({
                type:"POST",
                url:"<%=basePath%>blog/addVisitTime?id=${blog.id}",
                dataType:"json",
...
<div class="container" id="con" style="background-color: #fff;">
    ...
    <div id="intro" style="color:grey;font-size: 12px" class="col-md-8  text-center">
        作者：${blog.author}  |   日期：${blog.date.substring(0,10)}  | 访问次数：<div id="visittime" style="display: inline-block">${blog.visittime}</div>
    </div>
